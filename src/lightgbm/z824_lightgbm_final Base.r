...
PARAM$finalmodel$optim$num_iterations <- 1384
PARAM$finalmodel$optim$learning_rate <- 0.0200145077409981
PARAM$finalmodel$optim$feature_fraction <- 0.561483152530327
PARAM$finalmodel$optim$min_data_in_leaf <- 7036
PARAM$finalmodel$optim$num_leaves <- 354
