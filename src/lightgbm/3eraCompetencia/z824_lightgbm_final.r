...
PARAM$finalmodel$semilla <- 407801

# hiperparametros intencionalmente NO optimos
PARAM$finalmodel$optim$num_iterations <- 619
PARAM$finalmodel$optim$learning_rate <- 0.0434504901317402
PARAM$finalmodel$optim$feature_fraction <- 0.694896211806491
PARAM$finalmodel$optim$min_data_in_leaf <- 19807
PARAM$finalmodel$optim$num_leaves <- 489
